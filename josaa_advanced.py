...
def download_table(df,name):
    ...
    html = f'<a download="{op_file}" href="data:application/vnd.openxmlformats-officedocument.spreadsheetml.sheet;base64,{b64}">Click here to download the table results in an excel file !</a>'
