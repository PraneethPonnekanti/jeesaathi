# -*- coding: utf-8 -*-
"""
Created on Sun Sep 26 23:07:21 2021
...
def download_table(df,name):
    ...
    out: href string
    """
    op_file = "JeeSaathi_SearchResults_"+name+".xlsx"
    ...
    html = f'<a download="{op_file}" href="data:text/xml;base64,{payload}">Download the table results in an excel file here !</a>'
    #timestr = time.strf()
    #csv = df.to_csv(op_file,index=False)
